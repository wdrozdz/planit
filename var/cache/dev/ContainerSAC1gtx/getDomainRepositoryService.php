...
// Returns the private 'App\Repository\DomainRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DomainRepository.php';

return $this->privates['App\\Repository\\DomainRepository'] = new \App\Repository\DomainRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
